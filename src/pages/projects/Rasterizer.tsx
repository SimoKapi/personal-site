...
function Rasterizer() {
    return (
        <>
          ...
          <CopyableHeader id="spatial-transform" className="subsubheader-project">Spatial transformation</CopyableHeader>
          ...
          <CopyableHeader id="perspective-transform" className="subsubheader-project">Perpsective transformation</CopyableHeader>
          ...
          <p>The two similar triangles created both start in the origin <InlineMath math='O'/>, and stretch out to the <InlineMath math='y'/> point or the <InlineMath math='P_y'/> edge, respectively. Because they are similar, the ratios of their side lengths must remain the same; thus, <InlineMath math='\frac{P_z}{P_y} = \frac{E_z}{Ey}'/></p>
          ...
          <CopyableHeader id="backface-culling" className="subsubheader-project">Backface culling</CopyableHeader>
          ...
          <CopyableHeader id="shading" className="subsubheader-project">Shading</CopyableHeader>
          <div className="grid md:grid-cols-2 gap-8">
            <img className="col-span-1" src={Shading}/>
            <div>
              <p>Finally, I had to implement some form of face differentiation, to prevent the rendered object from looking flat. Originally, I just assigned each face a random color, before switching to a flat shading calculation. It is done by obtaining the dot product of the light vector and each face's normal vector, and using it to scale the color intensity. This changes its darkness based on the extent to which it's facing a given light source direction.</p>
            </div>
          </div>
          <p className='md:mt-2'>If the dot product between the normal vector and the light vector is negative, the two are at an angle greater than 90 degrees, thus facing away for each other. Faces with a negative dot product have their color intensity further scaled by 0.1, as they are facing away from the light source and minimal light should hit them.</p>

          <h1 className='subheader-project'>Fun Fact:</h1>
          <div className="grid md:grid-cols-2 gap-8">
            <p className='col-span-'>Did you know that if you treat degrees as radians in calculations, the whole render gets broken? I scratched my head over that for days before I found the problem. Here's how it looked with the error:</p>
